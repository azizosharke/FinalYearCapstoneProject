...
\begin{enumerate}
    ...
    \item Transparency Reporting Enhanced: Cloudflare looks forward to providing even more transparency reports that would provide a deep understanding of the types of DNS abuse and the effectiveness of its mitigation for improved abuse handling practice.
