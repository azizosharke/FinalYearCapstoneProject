...
\hline
\endlastfoot
Phishing & \mbox{Identity Theft}, Financial Loss & Security Awareness Training, Enhanced Domain Validation Procedures & \mbox{Training helps users} \mbox{recognize phishing} \mbox{attempts. Validation} prevents registration of mimic domains. & \mbox{Increases awareness and} \mbox{scrutiny during domain} registration. \\ \hline
...
\mbox{Mobile Device} Exploitation & Unauthorised Access, Financial Loss & MFA, Security Awareness Training & \mbox{Secures account} \mbox{access.} \mbox{ Raises awareness} of threats. & Mobile security awareness and protection. \\ \hline

\mbox{Cryptocurrency} \mbox{and Blockchain} Exploitation & \mbox{Financial Theft}, \mbox{Account} \mbox{Compromise} & \mbox{Enhanced Validation}, \mbox{Collaboration} & \mbox{Prevents fraudulent} \mbox{domain registrations.} \mbox{Collaboration on} \mbox{threat intelligence.} & Secure domain registration and defence. \\ \hline
...
\begin{figure}[ht!]
    ...
    \caption{Trends in COVID-themed phishing attacks from January 2020-February 2021}
...
\begin{figure}[ht!]
    ...
    \caption{Top phishing targets in COVID-related URLs (global). Each bar represents the percentage of phishing URLs attempting to steal users’ login credentials for that particular website. }
...
\begin{figure}[ht!]
    ...
    \caption{Age of websites that host COVID-related phishing pages at time of detection (global).}
